        ...
        if (link) {
          const navigateTo = (targetUrl) => {
            if (targetUrl.startsWith('pages/')) {
              ...
              // 如果已经是相对路径 (例如从 pages/xx.html 点击 sidebar 链接到 pages/yy.html)
              // sidebar.html 里的 data-href="pages/yy.html"
              // 从 components/sidebar/sidebar.js 跳转，实际需要 ../../pages/yy.html
              // 如果是 ../index.html, 则已经是正确的
              // 简化处理：假设 sidebar.html 内的链接都是相对于项目根目录的
              window.location.href = `../../${targetUrl.startsWith('../') ? targetUrl.substring(3) : targetUrl}`;
            } else {
              // 可能是 # 或者其他特殊链接，或者已经是 ../../ 开头的
              window.location.href = targetUrl;
            }
          };
